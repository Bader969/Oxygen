    ...
    filtered.forEach(d => {
        list.innerHTML += \`
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 px-stack-md py-4 hover:bg-white/5 transition-colors items-center group cursor-pointer">
                ...
                <!-- Action -->
                <div class="col-span-2 flex items-center md:justify-end gap-2 mt-4 md:mt-0">
                    <button class="hidden md:flex items-center gap-1 text-xs text-primary hover:text-white transition-colors">
                        <span class="material-symbols-outlined text-[14px]">history</span>
                    </button>
                    <button class="w-8 h-8 rounded-full bg-black/40 border border-primary/30 inline-flex items-center justify-center hover:bg-primary hover:text-black transition-colors text-primary ml-auto md:ml-0">
...
console.log('Built devices list view');
